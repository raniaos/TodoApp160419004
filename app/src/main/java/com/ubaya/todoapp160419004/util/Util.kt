package com.ubaya.todoapp160419004.util
...
//single expression, kalo mau val baru return liat ppt week 9 slide 11
...
val MIGRATION_2_3 = object : Migration(2, 3) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        //Karena pada SQLite tidak terdapat Boolean storage class, sehingga Boolean disimpan sebagai Integer dimana 0 merepresentasikan false dan 1 merepresentasikan true.
    }
